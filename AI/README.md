...
- Phase 6 (진행 중): M6.A1 수집 ✅ → … → M6.A6 모델 선정 ✅ → 매출 예측 고도화 ✅ → 다음 M6.A7 XAI
...
cd ../notebooks
jupyter nbconvert --to notebook --execute --inplace 01_eda.ipynb 02_features.ipynb 03_preprocessing.ipynb 04_baselines.ipynb 05_model_selection.ipynb 06_enhancement.ipynb
